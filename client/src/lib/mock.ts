...
export const MOCK_TECHS: UserRefDto[] = [
...
const requester = (id: string, name: string): UserRefDto => ({
  id,
  name,
...
function buildVolume(days: number): TimeSeriesPointDto[] {
...
export const MOCK_VOLUME_90: TimeSeriesPointDto[] = buildVolume(90);

export const MOCK_BY_STATUS: CountByKeyDto[] = [
...
export const MOCK_BY_PRIORITY: CountByKeyDto[] = [
...
export const MOCK_BY_CATEGORY: CountByKeyDto[] = [
...
export const MOCK_TECH_LOAD: TechnicianLoadDto[] = [
...
export const MOCK_WEEK_VOLUME: Array<{ day: string; created: number; resolved: number }> = [
...
export const MOCK_CRITICAL_INCIDENT: CriticalIncident = {
  id: 'INC-004',
...
export const MOCK_ASSET: MockAsset = {
  id: 'a-lap1029',
  tag: 'LAP-1029',
