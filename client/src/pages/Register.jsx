...
export default function Register() {
    ...
    return (<AuthLayout title="Create your account" subtitle="You will be able to raise tickets straight away." footer={<p className="text-xs text-ink-muted">
      ...
      <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)} noValidate>
        ...
        <Field label="Password" htmlFor="password" error={errors.password?.message} hint="At least 8 characters, including a letter and a number." required>
          <Input id="password" type="password" autoComplete="new-password" invalid={Boolean(errors.password)} {...form.register('password')}/>
        </Field>
