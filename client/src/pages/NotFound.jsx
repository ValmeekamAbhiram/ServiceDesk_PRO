...
export default function NotFound() {
    ...
    return (<Card>
      <EmptyState icon={<Compass className="h-5 w-5" aria-hidden="true"/>} title="There is nothing at this address" message="The link may be out of date, or the page may never have existed." action={<div className="flex flex-wrap items-center justify-center gap-2">
