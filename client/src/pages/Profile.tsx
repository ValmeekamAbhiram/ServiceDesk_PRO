...
const DETAIL_FIELDS = ['name', 'jobTitle', 'phone'] as const;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <DetailsCard
          user={user}
          onSaved={(fields) => applyProfile(fields)}
        />
...
function DetailsCard({
  ...
  user: { name: string; email: string; jobTitle: string | null; phone: string | null };
  onSaved: (fields: { name: string; jobTitle: string | null; phone: string | null }) => void;
}) {
