...
import type { AssetInput } from '@shared/types';
...
const asDateInput = (iso: string | null): string => (iso ? iso.slice(0, 10) : '');
...
function toPayload(values: FormValues): AssetInput {
  return {
    name: values.name,
    type: values.type,
          ...
          <form className="space-y-4" onSubmit={submit} noValidate>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field
                ...
                hint="Leave blank to keep it on the shelf."
                error={err.assignedToId?.message}
              >
              ...
              <Field
                ...
                hint="Must be unique if given."
                error={err.serialNumber?.message}
              >
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <Field
                ...
                error={err.warrantyExpiryDate?.message}
              >
                <Input
                  id="warrantyExpiryDate"
                  type="date"
                  {...form.register('warrantyExpiryDate')}
                />
              </Field>
            </div>
