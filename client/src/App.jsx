    ...
    return (<>
      <Routes>
        ...
        <Route element={<ProtectedRoute>
          ...
          <Route path="assets/new" element={<RequirePermission permission={Permission.ASSET_MANAGE}>
                <AssetEdit />
              </RequirePermission>}/>
          <Route path="assets/:id" element={<AssetDetail />}/>
          <Route path="assets/:id/edit" element={<RequirePermission permission={Permission.ASSET_MANAGE}>
                <AssetEdit />
              </RequirePermission>}/>
          ...
          * route, because it is a decision about an existing draft. */}
          <Route path="knowledge/new" element={<RequirePermission permission={Permission.ARTICLE_WRITE}>
                <ArticleEdit />
              </RequirePermission>}/>
          <Route path="knowledge/:id" element={<ArticleDetail />}/>
          <Route path="knowledge/:id/edit" element={<RequirePermission permission={Permission.ARTICLE_WRITE}>
                <ArticleEdit />
              </RequirePermission>}/>
          <Route path="notifications" element={<Notifications />}/>
          <Route path="profile" element={<Profile />}/>
          <Route path="admin/users" element={<RequirePermission permission={Permission.USER_MANAGE}>
                <AdminUsers />
              </RequirePermission>}/>
          <Route path="admin/categories" element={<RequirePermission permission={Permission.SETTINGS_MANAGE}>
                <AdminCategories />
              </RequirePermission>}/>
          <Route path="admin/sla" element={<RequirePermission permission={Permission.SETTINGS_MANAGE}>
                <AdminSlaPolicy />
              </RequirePermission>}/>
          ...
          * deployment are different privileges, and the server enforces them apart. */}
          <Route path="admin/audit" element={<RequirePermission permission={Permission.AUDIT_READ}>
                <AdminAuditLog />
              </RequirePermission>}/>
          ...
          * effective, so the route needs only the settings permission. */}
          <Route path="admin/settings" element={<RequirePermission permission={Permission.SETTINGS_MANAGE}>
                <AdminSettings />
              </RequirePermission>}/>
