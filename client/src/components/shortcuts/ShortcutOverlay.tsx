...
export function ShortcutOverlay() {
  ...
  return (
    <Modal
      ...
      description="Navigate common service-desk tasks without leaving the keyboard."
      size="sm"
    >
      <dl className="divide-y divide-line">
        {SHORTCUTS.map((shortcut) => {
          ...
          return (
            <div key={shortcut.label} className="flex items-center justify-between gap-4 py-3 first:pt-0 last:pb-0">
