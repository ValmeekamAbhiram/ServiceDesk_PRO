      ...
      {toasts.map((toast) => {
        ...
        return (
          <div
            key={toast.id}
            className={cn(
              'pointer-events-auto flex w-full max-w-sm animate-fade-in-up items-start gap-2.5 rounded-lg px-3.5 py-3 shadow-pop ring-1 ring-inset',
              TONE_SOFT[toast.tone]
            )}
          >
