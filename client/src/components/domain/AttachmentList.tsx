      ...
      {attachments.map((attachment) => (
        <li key={attachment.id}>
          <a
            ...
            className="group flex items-center gap-2 rounded-md border border-line bg-surface-sunken px-2.5 py-1.5 text-xs hover:border-line-strong"
          >
            ...
            <Download
              className="h-3.5 w-3.5 shrink-0 text-ink-subtle opacity-0 transition-opacity group-hover:opacity-100"
              aria-hidden="true"
            />
          </a>
        </li>
