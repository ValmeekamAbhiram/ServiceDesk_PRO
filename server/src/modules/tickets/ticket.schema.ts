...
export const listTicketsSchema = {
  query: z.object({
    q: querySearch,
    status: queryEnumList(TICKET_STATUSES as [TicketStatus, ...TicketStatus[]]),
    priority: queryEnumList(PRIORITIES as [Priority, ...Priority[]]),
    categoryId: objectIdField.optional(),
...
export type ReopenTicketInput = z.infer<typeof reopenTicketSchema.body>;
export type IdParams = z.infer<typeof ticketIdSchema.params>;
