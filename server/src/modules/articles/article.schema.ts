...
const ARTICLE_SORT_FIELDS = ['updatedAt', 'publishedAt', 'viewCount', 'title'] as const;
...
export type ArticleInputBody = z.infer<typeof articleBody>;
export type UpdateArticleInput = z.infer<typeof updateArticleSchema.body>;
export type ListArticlesInput = z.infer<typeof listArticlesSchema.query>;
export type SearchArticlesInput = z.infer<typeof searchArticlesSchema.query>;
export type PublishArticleInput = z.infer<typeof publishArticleSchema.body>;
