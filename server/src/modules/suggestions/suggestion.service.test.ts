...
async function employee(): Promise<ActorContext> {
...
async function makeCategory(spec: CategorySpec): Promise<string> {
...
async function makeArticle(title: string, status: ArticleStatus, body: string): Promise<void> {
