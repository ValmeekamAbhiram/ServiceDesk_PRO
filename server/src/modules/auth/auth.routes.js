...
import { changePasswordSchema, loginSchema, refreshSchema, registerSchema, } from '@/modules/auth/auth.schema';
...
authRouter.post('/change-password', authenticate(), authRateLimit(), validate(changePasswordSchema), controller.changePassword);
