...
const ASSET_SORT_FIELDS = ['name', 'tag', 'createdAt', 'warrantyExpiryDate'] as const;
...
export const listAssetsSchema = {
  query: z.object({
    ...
    limit: queryLimit,
    q: querySearch,
    type: queryEnumList(ASSET_TYPES as [AssetType, ...AssetType[]]),
    status: queryEnumList(ASSET_STATUSES as [AssetStatus, ...AssetStatus[]]),
...
export type AssetInputBody = z.infer<typeof assetBody>;
export type UpdateAssetInput = z.infer<typeof updateAssetSchema.body>;
export type ListAssetsInput = z.infer<typeof listAssetsSchema.query>;
