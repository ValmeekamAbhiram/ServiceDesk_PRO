...
assetSchema.index({ tag: 'text', name: 'text', serialNumber: 'text', model: 'text' }, { name: 'asset_search', weights: { tag: 20, serialNumber: 10, name: 8, model: 4 } });
export const Asset = defineModel('Asset', assetSchema);
