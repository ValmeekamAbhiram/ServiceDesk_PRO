...
export const STAFF_ROLES: Role[] = [Role.ADMIN, Role.TECHNICIAN];
...
export const TICKET_STATUSES = Object.values(TicketStatus) as TicketStatus[];
...
export const PRIORITIES = Object.values(Priority) as Priority[];
...
export const COMMENT_VISIBILITIES = Object.values(CommentVisibility) as CommentVisibility[];
...
export const TERMINAL_SLA_STATES: SlaState[] = [SlaState.MET, SlaState.BREACHED];
...
export const ASSET_STATUSES = Object.values(AssetStatus) as AssetStatus[];
...
export const ARTICLE_STATUSES = Object.values(ArticleStatus) as ArticleStatus[];
...
export const AUDIT_ENTITIES = Object.values(AuditEntity) as AuditEntity[];
...
export const PERMISSIONS = Object.values(Permission) as Permission[];
...
export const CLOCK_MODES = Object.values(ClockMode) as ClockMode[];
